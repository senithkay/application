...
export default function Component() {
  return (
    <div className="w-full">
      <section className="w-full py-8 md:py-8 lg:py-10 bg-gradient-to-r from-[#6b7280] to-[#4b5563] text-white">
        <div className="container px-4 md:px-6 grid gap-6 lg:grid-cols-2 lg:gap-12">
          ...
          <div className="flex items-center justify-center">
            <img src="/placeholder.svg" width="500" height="400" alt="Gems" className="rounded-xl object-cover" />
          </div>
        </div>
      </section>
